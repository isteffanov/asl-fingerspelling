...
encoder2 = LSTM(256, return_sequences=True, return_state=True)
encoder_outputs2, state_h2, state_c2 = encoder2(encoder_outputs)

encoder3 = LSTM(256, return_sequences=True, return_state=True)
...
# RESULTS
#165/165 [==============================] - 10s 61ms/step - loss: 0.0039 - accuracy: 0.3121 - cosine_similarity: 0.3141 - val_loss: 0.0076 - val_accuracy: 0.1326 - val_cosine_similarity: 0.1513
