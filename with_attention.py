...
decoder_outputs, _, _ = decoder(decoder_inputs, initial_state=[state_h2, state_c2])

# Attention
attn_layer = AttentionLayer(name='attention_layer')
attn_out, attn_states = attn_layer([encoder_outputs2, decoder_outputs])
...
#165/165 [==============================] - 17s 102ms/step - loss: 0.0051 - accuracy: 0.2674 - cosine_similarity: 0.2564 - val_loss: 0.0072 - val_accuracy: 0.1457 - val_cosine_similarity: 0.1646
#
